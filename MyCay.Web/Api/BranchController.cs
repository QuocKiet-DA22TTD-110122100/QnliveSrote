...
public class BranchController : ControllerBase
{
    ...
    public BranchController(MyCayDbContext context)
    {
        _context = context;
    }
    ...
    public async Task<IActionResult> Create([FromBody] ChiNhanh branch)
    {
        ...
        return Ok(new { message = "Tạo chi nhánh thành công", id = branch.MaCN });
    }
    ...
    public async Task<IActionResult> Delete(int id)
    {
        ...
        await _context.SaveChangesAsync();
        return Ok(new { message = "Đã vô hiệu hóa chi nhánh" });
    }
}
